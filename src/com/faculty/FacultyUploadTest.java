...
/**
 * Servlet implementation class FacultyUploadTest
 */
@WebServlet("/facultyUploadTest")
@MultipartConfig
public class FacultyUploadTest extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FacultyUploadTest() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(session.getAttribute("facultyemail")!=null) {
	          ...
	          out.println("location='facultyUploadCourseTest.jsp';");
	          out.println("</script>");
