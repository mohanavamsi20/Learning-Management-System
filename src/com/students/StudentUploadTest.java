...
/**
 * Servlet implementation class StudentUploadTest
 */
@WebServlet("/studentUploadTest")
@MultipartConfig
public class StudentUploadTest extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	try {        		
            if(session.getAttribute("email")!=null) {
    	          ...
    	          out.println("location='studentUploadCourseTest.jsp';");
    	          out.println("</script>");
