...
<head>
	...
	<title>Course Content Home</title>
...
<body>
	...
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
	    ...
	    <li class="breadcrumb-item active" aria-current="page">Course Content Home</li>
	  </ol>
	</nav>
	<br>
	<%
    ...
    <br>
   	...
   	PreparedStatement ps = connection.prepareStatement("SELECT * FROM COURSEMATERIALS WHERE COURSEID=? AND FILE_TITLE=?");
