...
<head>
    ...
    <title>DELETE STUDENT COURSES</title>
...
.close:focus {
  ...
  <body>
    ...
    <form align="center" action="deleteStudentCourses" method="post">
    ...
    <button id="myBtn" type="button">DELETE COURSES TO STUDENTS</button>
