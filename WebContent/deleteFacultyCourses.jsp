...
<head>
    ...
    <title>DELETE FACULTY COURSES</title>
...
.close:focus {
  ...
  <body>
    ...
    <form align="center" action="deleteFacultyCourses" method="post">
    ...
    <button id="myBtn" type="button">DELETE COURSES TO FACLUTY</button>
    ...
    <tbody>
    <%
	PreparedStatement ps3 = connection.prepareStatement("SELECT * FROM FACULTY");
	...
	<form align="center" action="facultyCourses.jsp"method="post">
		<button type="submit">FACULTY COURSES</button>
	</form>
